...
public static class TransitionManager
{
    ...
    public static Sequence Transition(this Transform transform ,TransformEffectActionConfig transitionPackConfig, Action onComplete = null)
    {
    ...
    public static Sequence Transition(this Transform transform , Transform destination, TransformEffectActionConfig transitionPackConfig, Action onComplete = null)
    {
    ...
    public static Sequence Transition(this Transform transform ,Vector3 destination, TransformEffectActionConfig transitionPackConfig, Action onComplete = null)
    {
        Sequence sequence = DOTween.Sequence();
    ...
    public static Sequence Move(this Transform transform, TransformEffectActionConfig transitionPackConfig, Action onComplete = null)
    {
        Vector3 destination = Vector3.zero;
    ...
    public static Sequence Move(this Transform transform,Transform destination, TransformEffectActionConfig transitionPackConfig, Action onComplete = null)
    {
        return transform.Move(destination.position, transitionPackConfig, onComplete);
    }

    public static Sequence Move(this Transform transform,Vector3 destination, TransformEffectActionConfig transitionPackConfig, Action onComplete = null)
    {
    ...
    public static Tween Scale(this Transform transform,TransformEffectActionConfig transitionPackConfig, Action onComplete = null)//transitionPackConfig scale input
    {
        switch (transitionPackConfig.ScaleType)
        {
            case TransformEffectActionConfig.ScaleTypeEnum.ByFloat:
    ...
    public static Tween Scale(this Transform transform,float multiply, TransformEffectActionConfig transitionPackConfig, Action onComplete = null)//multiply scale input
    {
        return transform.Scale(multiply, transitionPackConfig.Scale, onComplete);
    }

    public static Tween Scale(this Transform transform,Vector3 scaleVector, TransformEffectActionConfig transitionPackConfig, Action onComplete = null)//scaleVector scale input
    {
    ...
    public static Tween Rotate(this Transform transform,TransformEffectActionConfig transitionPackConfig, Action onComplete = null)
    {
        return transform.Rotate(transitionPackConfig.Rotate, transitionPackConfig, onComplete);
    }

    public static Tween Rotate(this Transform transform,Vector3 destination, TransformEffectActionConfig transitionPackConfig, Action onComplete = null)
    {
    ...
    private static Sequence DoMove(this Transform transform, Vector3 destination, TransformEffectActionConfig transitionPackConfig = null,
        Action onComplete = null)
    {
        ...
        switch (transitionPackConfig != null ? transitionPackConfig.PositionMoveTypeEnum : (TransformEffectActionConfig.PositionMoveType?)null)
        {
            case TransformEffectActionConfig.PositionMoveType.Local:
